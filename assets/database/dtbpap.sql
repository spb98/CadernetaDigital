...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Jun-2018 às 19:23
...
CREATE TABLE `alunos` (
  ...
  `Nome` text COLLATE latin1_spanish_ci NOT NULL,
  `Morada` text COLLATE latin1_spanish_ci NOT NULL,
  `Localidade` text COLLATE latin1_spanish_ci NOT NULL,
  `CC` text COLLATE latin1_spanish_ci NOT NULL,
  `Sexo` text COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE `escolas` (
  ...
  `Designacao` text COLLATE latin1_spanish_ci NOT NULL,
  `Localidade` text COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE `estabelecimento` (
  ...
  `Contacto` int(15) NOT NULL,
  `Email` text COLLATE latin1_spanish_ci NOT NULL,
  `Website` text COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `recados` (
  ...
  `IdEncarregado` int(11) NOT NULL,
  `IdAluno` int(11) NOT NULL,
  `Mensagem` text COLLATE latin1_spanish_ci NOT NULL,
  `DataEnvio` date NOT NULL,
  `DataConfirmacao` date NOT NULL,
  `Lido` varchar(1) COLLATE latin1_spanish_ci NOT NULL DEFAULT 'n',
  `Comparece` varchar(1) COLLATE latin1_spanish_ci NOT NULL DEFAULT '?'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `turmas` (
  ...
  `IdProfessor` int(11) NOT NULL,
  `Ano` int(2) NOT NULL,
  `Turma` text COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
--
ALTER TABLE `recados`
  MODIFY `IdRecado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
