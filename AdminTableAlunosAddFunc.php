...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO alunos (IdEncarregados,Nome,Morada,Localidade,CC,Sexo,DataNascimento,foto) VALUES ('$idencarregados','$nome','$morada','$localidade','$cc','$sexo','$datanascimento','$foto')";
