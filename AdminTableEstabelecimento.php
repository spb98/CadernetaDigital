...
<body
    ...
    if (isset($_GET['delete'])) {
        ...
        $sql = "DELETE FROM estabelecimentos WHERE IdEstabelecimento = $delete_id";
                    ...
                    <div class=\"modal-dialog modal-lg\" role=\"document\">
                        <div class=\"modal-content\">
                            ...
                            <div class=\"modal-body\">
                                 ID do estabelecimento: $row2[0]
                                 <br>
                                 Designação do estabelecimento: $row2[1]
                                 <br>
                                 Localidade do estabelecimento: $row2[2]
                                 <br>
                                 Contacto do estabelecimento: $row2[3]
                                 <br>
                                 Email do estabelecimento: $row2[4]
                                 <br>
                                 Website do estabelecimento: $row2[5]
                            </div>
